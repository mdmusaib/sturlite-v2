  ...
  const resetToStoredValues = useCallback(() => {
    if (store.selectedEvent !== null) {
      ...
      setValues({
        ...
        calendar: event.extendedProps.calendar || 'EnquiriesTasks',
      ...
      <Box className='sidebar-body' sx={{ p: theme => theme.spacing(0, 6, 6) }}>
        <DatePickerWrapper>
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            >
              <MenuItem value='AssignedTasks'>AssignedTasks</MenuItem>
              <MenuItem value='EnquiriesTasks'>EnquiriesTasks</MenuItem>
              <MenuItem value='FollowUp'>FollowUp</MenuItem>
              <MenuItem value='Reminder'>Reminder</MenuItem>
              <MenuItem value='TasksDone'>TasksDone</MenuItem>
            </CustomTextField>
            <Box sx={{ mb: 4 }}>
              <DatePicker
                selectsStart
