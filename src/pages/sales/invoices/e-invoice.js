...
const EInvoiceGenerated = () => {
  ...
  const fetchData = async () => {
    ...
    const APIURL = `http://51.38.17.25:50001/b1s/v1/Invoices?$select=DocEntry,DocNum,DocType,DocumentStatus,DocDate,CardName,DocTotal&$filter=U_E_IRNSTA eq 'null' and Cancelled ne 'Y' and BPL_IDAssignedToInvoice eq 3 &$orderby=DocEntry&$top=100&$skip=1`;
...
//   useEffect(() => { }, [data, search])
  ...
  return (
    <Card>
      <CardHeader title='Open Sale Invoice' />
      <Grid
        container
        spacing={5}
        sx={{
        ...
        <Grid item >
          {/* <Link href='/sales/create-leads'>
            <Button variant='contained'>Open Sale Invoice</Button>
          </Link> */}
        </Grid>
      </Grid>
...
export default EInvoiceGenerated;
