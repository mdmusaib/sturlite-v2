...
const SalesOrders = () => {
  ...
  const fetchData = async () => {
    ...
    const APIURL = `http://51.38.17.25:50001/b1s/v1/Orders?$filter=DocumentStatus eq 'O'  and BPL_IDAssignedToInvoice eq 3 &$orderby=DocEntry&$top=10&$skip=1`;
...
const handleCustomPagination=(page)=>{
  ...
  return (
    <Card>
      <CardHeader title='Open Sale Order' />
      <Grid
        container
        spacing={5}
        sx={{
